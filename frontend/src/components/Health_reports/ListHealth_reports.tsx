              ...
              >
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>
                      {dataFormatter.animalsOneListFormatter(item.animal)}
                    </p>
                  </div>
                </div>
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/health_reports/health_reports-edit/?id=${item.id}`}
                  pathView={`/health_reports/health_reports-view/?id=${item.id}`}
                  hasUpdatePermission={hasUpdatePermission}
                />
              </div>
            </CardBox>
          ))}
        {!loading && health_reports.length === 0 && (
...
export default ListHealth_reports;
