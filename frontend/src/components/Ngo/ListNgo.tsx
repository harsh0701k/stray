...
const ListNgo = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_NGO');
            ...
            >
              ...
              >
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/ngo/ngo-edit/?id=${item.id}`}
                  pathView={`/ngo/ngo-view/?id=${item.id}`}
                  hasUpdatePermission={hasUpdatePermission}
                />
              </div>
            </CardBox>
          ))}
        {!loading && ngo.length === 0 && (
