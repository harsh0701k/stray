...
const ListNgos = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_NGOS');
              ...
              >
                ...
                >
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>NGOName</p>
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/ngos/ngos-edit/?id=${item.id}`}
                  pathView={`/ngos/ngos-view/?id=${item.id}`}
