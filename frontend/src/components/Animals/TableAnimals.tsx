...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/animals/animalsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureAnimalsCols';
...
const TableSampleAnimals = ({
  ...
  useEffect(() => {
    if (animalsNotify.showNotification) {
      notify(animalsNotify.typeNotification, animalsNotify.textNotification);
    }
  }, [animalsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/animals/animals-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {animals && Array.isArray(animals) && !showGrid && (
        <ListAnimals
          animals={animals}
          loading={loading}
...
export default TableSampleAnimals;
