      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <div className={'mb-4'}>
            ...
            <p>{users?.ngo?.name ?? 'No data'}</p>
          </div>

          <>
            <p className={'block font-bold mb-2'}>Alerts NotifiedUser</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.alerts_notified_user &&
                      Array.isArray(users.alerts_notified_user) &&
                      users.alerts_notified_user.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
              ...
              {!users?.alerts_notified_user?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
          ...
          <>
            <p className={'block font-bold mb-2'}>Animals AssignedCaregiver</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.animals_assigned_caregiver &&
                      Array.isArray(users.animals_assigned_caregiver) &&
                      users.animals_assigned_caregiver.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
              ...
              {!users?.animals_assigned_caregiver?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
