...
module.exports = class UsersDBApi {
  static async create(data, globalAccess, options) {
    ...
    await users.setNgo(data.data.ngo || null, {
      transaction,
    });
  ...
  static async update(id, data, globalAccess, options) {
    ...
    await users.setNgo(data.ngo || null, {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    output.alerts_notified_user = await users.getAlerts_notified_user({
      transaction,
    });

    output.animals_assigned_caregiver =
      await users.getAnimals_assigned_caregiver({
        transaction,
      });
